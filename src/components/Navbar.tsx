          ...
          <div className="flex items-center justify-between h-14 lg:h-16">
            ...
            <div className="lg:hidden flex items-center justify-end w-full h-14 relative z-[150] px-4">
              <button
                ...
                className="group relative w-12 h-12 flex items-center justify-center active:bg-white/10 active:scale-90 rounded-full transition-all duration-300 overflow-hidden"

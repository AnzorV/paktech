...
const Navbar: React.FC = () => {
  ...
  const isActive = (item: any) => {
    ...
    // Check if the current path starts with the item's href (for hierarchical highlighting)
                        ...
                        {item.submenu.map((sub, idx) => (
                          ...
                          >
                            ...
                            >
                              ...
                              {sub.submenu && <ChevronRight className="w-4 h-4 opacity-30 group-hover/sub:opacity-100 group-hover/sub:translate-x-1 transition-all" />}
                            </Link>
                            {sub.submenu && (
                              <div className="absolute left-full top-[-12px] w-64 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-300 pl-2">
